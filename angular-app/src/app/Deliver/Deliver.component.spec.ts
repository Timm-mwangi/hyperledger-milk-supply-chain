...
describe('DeliverComponent', () => {
  ...
  let mockDeliverService;
  let mockDataService

  beforeEach(async(() => {

    mockDeliverService = sinon.createStubInstance(DeliverService);
    mockDeliverService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: DeliverService, useValue: mockDeliverService },

...
describe('CreateManufacturerComponent', () => {
  ...
  let mockCreateManufacturerService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateManufacturerService = sinon.createStubInstance(CreateManufacturerService);
    mockCreateManufacturerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateManufacturerService, useValue: mockCreateManufacturerService },

...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be milk_blockchain@0.0.3',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('milk_blockchain@0.0.3.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Milk table should have 5 columns',() => {
      page.navigateTo('/Milk');
    ...
    it('Batch table should have 3 columns',() => {
      page.navigateTo('/Batch');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('SysAdmin table should have 3 columns',() => {
      page.navigateTo('/SysAdmin');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(3); // Addition of 1 for 'Action' column
      });
    ...
    it('CreateManufacturer component should be loadable',() => {
      page.navigateTo('/CreateManufacturer');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateManufacturer');
      });
    });
  
    it('CreateDistributor component should be loadable',() => {
      page.navigateTo('/CreateDistributor');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateDistributor');
      });
    });
  
    it('CreateRetailer component should be loadable',() => {
      page.navigateTo('/CreateRetailer');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateRetailer');
      });
    });
  
    it('CreateMilk component should be loadable',() => {
      page.navigateTo('/CreateMilk');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateMilk');
      });
    });
  
    it('CreateBatch component should be loadable',() => {
      page.navigateTo('/CreateBatch');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateBatch');
      });
    });
